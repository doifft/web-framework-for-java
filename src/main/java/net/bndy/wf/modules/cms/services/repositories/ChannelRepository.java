...
public interface ChannelRepository extends JpaRepository<Channel, Long> {
    ...
    @Query(value = "UPDATE cms_channel SET is_visible=TRUE WHERE id IN (:ids)", nativeQuery = true)//pgsql
    ...
    @Query(value = "UPDATE cms_channel SET is_visible=FALSE WHERE path LIKE :path%", nativeQuery = true)//pgsql
